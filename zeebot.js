...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━\\        
		...
		mess = {
		 ban : 'Lu Udh Di Ban Kentod',
		  glimit : '```Limit Lu Habis Tolol```',
		   limit: `Upss maaf kak ${pushname} limit kamu sudah habis`,
			wait: '```Sabar Ya Kentod Ni Lagi Usaha...```',
		  	  success: '```Ni Udh Berhasil Babi```',
			   error: {
				stick: '```𝘚𝘵𝘪𝘤𝘬𝘦𝘳 𝘈𝘦 𝘟𝘰𝘯𝘵𝘰𝘭```',
				 Iv: '*403 ERROR!! URL INVALID PLEASE CHECK AGAIN*',				 
				  api: '*404 ERROR!! APIKEY INVALID*',
			       ...
			       only: {
	    	        group: '```𝘒𝘩𝘶𝘴𝘶𝘴 𝘎𝘳𝘰𝘶𝘱 Tolol```',
	    	         owner: 'Khusus Owner Kntl',
	    	          admin: 'Khusus Admin Goblok...',
	    	           prem: 'Khusus Member Premium Mmk...',
...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "fileName": "AllukaZoldyck BY AlwanKarsa.pdf",
